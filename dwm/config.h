...
static const Key keys[] = {
    ...
    { MODKEY | ShiftMask,                   XK_minus,           spawn,              SHCMD("pkexec brillo -U 5 -q; kill -57 $(pidof dwmblocks)") },
    { MODKEY | ShiftMask,                   XK_equal,           spawn,              SHCMD("pkexec brillo -A 5 -q; kill -57 $(pidof dwmblocks)") },
